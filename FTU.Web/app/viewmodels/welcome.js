define(['knockout', 'jquery', 'app/common/dataaccess'], function (ko, $, da) {
    var vm =  {
        ...
        students: ko.observableArray(['Abhinav', 'Aasha', 'Vinay']),
        activate: function () {
            vm.displayName(da.getInfo());

            da.getStudents(function (data) {
                $.each(data, function (index, item) {
                    vm.students.push(item.FirstName);
                });
            });
        }
    }
